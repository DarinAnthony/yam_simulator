...
from .yam_simulator_2_marl_env_cfg import YamSimulator2MarlEnvCfg


class YamSimulator2MarlEnv(DirectMARLEnv):
    cfg: YamSimulator2MarlEnvCfg

    def __init__(self, cfg: YamSimulator2MarlEnvCfg, render_mode: str | None = None, **kwargs):
